...
export default function InteractiveDocuments({ dictionary, lang }: InteractiveDocumentsProps) {
  ...
  const documents = [
    {
      id: "mecana-story",
      title: dictionary.documents.mecana_story,
      description: dictionary.documents.story_description,
      type: "story",
    ...
    {
      id: "invitation",
      title: dictionary.documents.invitation,
      description: dictionary.documents.invitation_description,
      type: "invitation",
    ...
    <section className="py-16 bg-gradient-to-br from-primary/5 to-secondary/5">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">{dictionary.documents.title}</h2>
