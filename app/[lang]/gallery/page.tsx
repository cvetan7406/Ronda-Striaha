...
export default async function GalleryPage({ params: { lang } }: { params: { lang: Locale } }) {
  try {
    ...
    // Ensure dictionary.gallery exists with fallbacks
    const galleryDict = dictionary?.gallery || {
      title: lang === "bg" ? "Галерия" : "Γκαλερί",
      firstDay: lang === "bg" ? "Първи учебен ден" : "Πρώτη μέρα στο σχολείο",
      christmas: lang === "bg" ? "Коледа" : "Χριστούγεννα",
      nationalDay: lang === "bg" ? "Ден на народните будители" : "Ημέρα Εθνικής Αφύπνισης",
      easter: lang === "bg" ? "Великден" : "Πάσχα",
      ourArt: lang === "bg" ? "Нашето изкуство" : "Η τέχνη μας",
      classroom: lang === "bg" ? "Виртуална обиколка" : "Εικονική περιήγηση",
      viewAlbum: lang === "bg" ? "Разгледай албума" : "Δείτε το άλμπουμ",
    }
        ...
        <div className="pt-24">
          ...
          <section className="py-16 bg-gradient-to-r from-primary/10 to-secondary/10">
            <div className="container mx-auto px-4 text-center">
              <h1 className="text-4xl font-bold mb-6">{galleryDict.title}</h1>
          ...
          <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold text-center mb-12">{galleryDict.classroom}</h2>
